...
void BinauralPanner::nextBuffer(Buffer & outputBuffer) noexcept(false) {
...
//			memcpy(outputBuffer.buffer(0), mInBuf.buffer(0), numFrames * sizeof(samp));
//			memcpy(outputBuffer.buffer(1), mInBuf.buffer(0), numFrames * sizeof(samp));
//			return;
////////														// Get the cached data	
