...
void AmbisonicEncoder::nextBuffer(Buffer &outputBuffer, unsigned outBufNum) noexcept(false) {
...
// To get my next buffer, get a buffer from the input, and then "process" it...
void AmbisonicDecoder::nextBuffer(Buffer &outputBuffer, unsigned outBufNum) noexcept(false) {	
