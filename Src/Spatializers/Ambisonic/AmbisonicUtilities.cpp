...
void AmbisonicMixer::nextBuffer(Buffer &outputBuffer, unsigned outBufNum) noexcept(false) {
...
void AmbisonicRotator::nextBuffer(Buffer &outputBuffer, unsigned outBufNum) noexcept(false) {
