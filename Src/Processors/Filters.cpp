...
void Filter::nextBuffer(Buffer & outputBuffer, unsigned outBufNum) noexcept(false) {
#ifdef CSL_DEBUG
...
void Biquad::nextBuffer(Buffer & outputBuffer, unsigned outBufNum) noexcept(false) {
	SampleBuffer out = outputBuffer.buffer(outBufNum);		// get ptr to output channel
	unsigned numFrames = outputBuffer.mNumFrames;			// get buffer length
	SampleBuffer inP;
	if (isInline) {
...
void Moog::nextBuffer(Buffer & outputBuffer, unsigned outBufNum) noexcept(false) {
#ifdef CSL_DEBUG
