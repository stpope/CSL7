...
void Mixer::nextBuffer(Buffer & outputBuffer) noexcept(false) {
...
void Panner::nextBuffer(Buffer &outputBuffer) noexcept(false) {
...
void NtoMPanner::nextBuffer(Buffer &outputBuffer) noexcept(false) {
	unsigned numFrames = outputBuffer.mNumFrames;
...
void StereoWidth::nextBuffer(Buffer & outputBuffer) noexcept(false) {
