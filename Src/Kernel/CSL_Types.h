...
///     Updated for CSL 7.0 December, 2022
///
...
#ifdef CSL_WINDOWS
	#define CSL_DATA_DIR "..\\..\\..\\CSL7\Data\\"	///< folder where the CSL data can be found
	#define CSL_INIT_FILE "..\\..\\..\\csl.ini"		///< where to store the CSL init file
#else
	#define CSL_DATA_DIR "~/Code/CSL7/Data/"		///< folder where the CSL data can be found
