...
void FFTW_Wrapper::nextBuffer(Buffer & in, Buffer & out) noexcept(false) {	
...
void FFTR_Wrapper::nextBuffer(Buffer & in, Buffer & out) noexcept(false) {
	if (mDirection == CSL_FFT_FORWARD) {			// mDirection == CSL_FFT_FORWARD
...
void KISSFFT_Wrapper::nextBuffer(Buffer & in, Buffer & out) noexcept(false) {
