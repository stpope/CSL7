...
void StaticVariable:: nextBuffer(Buffer & outputBuffer, unsigned outBufNum) noexcept(false) {
...
void DynamicVariable:: nextBuffer(Buffer & outputBuffer, unsigned outBufNum) noexcept(false) {
...
//void DynamicVariable::nextBuffer(Buffer & outputBuffer) noexcept(false) {
//	Effect::pullInput(outputBuffer);
...
void RandomVariable:: nextBuffer(Buffer & outputBuffer, unsigned outBufNum) noexcept(false) {
	unsigned numFrames = outputBuffer.mNumFrames;
	SampleBuffer outp = outputBuffer.buffer(outBufNum];
