...
void WhiteNoise::nextBuffer(Buffer & outputBuffer, unsigned outBufNum) noexcept(false) {
...
void PinkNoise::nextBuffer(Buffer & outputBuffer, unsigned outBufNum) noexcept(false) {
