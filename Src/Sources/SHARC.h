...
///
/// SHARC spectrum class - a single spectrum for a note
///
...
///
/// SHARC instrument class - a list of spectra for an instrument
///
...
///
/// SHARC library class - the collection of 39 instruments
///
...
public:				// Data members
	...
	void dump(bool verbose = false);
					// For debugging
	void dump_stats(bool verbose = false);
	void dump_example();
