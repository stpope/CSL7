...
/* SHARC instruments
 Loaded SHARC library = 39 instruments, 1338 spectra, 71860 partials
	 altoflute_vibrato  --  30 spectra
	 cello_martele  --  44 spectra
	 Bach_trumpet  --  32 spectra
	 CB_pizz  --  41 spectra
	 viola_muted_vibrato  --  39 spectra
	 French_horn_muted  --  37 spectra
	 bassflute_vibrato  --  26 spectra
	 French_horn  --  37 spectra
	 trombone  --  36 spectra
	 bassoon  --  32 spectra
	 violin_pizzicato  --  37 spectra
	 flute_vibrato  --  37 spectra
	 Eb_clarinet  --  32 spectra
	 C_trumpet  --  34 spectra
	 bass_trombone  --  25 spectra
	 oboe  --  32 spectra
	 Bb_clarinet  --  37 spectra
	 bass_clarinet  --  25 spectra
	 English_horn  --  30 spectra
	 violin_vibrato  --  42 spectra
	 viola_vibrato  --  39 spectra
	 viola_pizzicato  --  34 spectra
	 contrabassoon  --  32 spectra
	 CB_martele  --  37 spectra
	 cello_pizzicato  --  39 spectra
	 piccolo  --  30 spectra
	 cello_muted_vibrato  --  34 spectra
	 violin_martele  --  34 spectra
	 viola_martele  --  36 spectra
	 violin_muted_vibrato  --  42 spectra
	 CB_muted  --  39 spectra
	 tuba  --  31 spectra
	 C_trumpet_muted  --  31 spectra
	 alto_trombone  --  13 spectra
	 cello_vibrato  --  44 spectra
	 trombone_muted  --  33 spectra
	 CB  --  38 spectra
	 contrabass_clarinet  --  23 spectra
	 violinensemb  --  44 spectra*/
...
void SHARCLibrary::dump_stats(bool verbose) {
	...
	if (verbose)
		for (int i = 0; i < inst_c; i++)
			logMsg("\t\t%s  --  %d spectra", _instruments[i]->_name, _instruments[i]->count_spectra());
}
...
void SHARCLibrary::dump(bool verbose) {
	SHARCInstrument * inst;
