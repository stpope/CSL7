...
void LineSegment::nextBuffer(Buffer &outputBuffer, unsigned outBufNum) noexcept(false) {
...
void Envelope::nextBuffer(Buffer &outputBuffer, unsigned outBufNum) noexcept(false) {
	SampleBuffer outPtr = outputBuffer.buffer(outBufNum);
	unsigned numFrames = outputBuffer.mNumFrames;
...
void RandEnvelope::nextBuffer(Buffer &outputBuffer, unsigned outBufNum) noexcept(false) {
	SampleBuffer outPtr = outputBuffer.buffer(outBufNum);
	unsigned numFrames = outputBuffer.mNumFrames;
