...
void LSoundFile::openForRead(bool load) noexcept(false) {
...
void LSoundFile::openForWrite(SoundFileFormat tformat, unsigned tchannels, 
					unsigned rate, unsigned bitDepth) noexcept(false) {
...
void LSoundFile::openForReadWrite() noexcept(false) {
...
void LSoundFile::writeBuffer(Buffer &inputBuffer, unsigned fromFrame, unsigned toFrame) noexcept(false) {
